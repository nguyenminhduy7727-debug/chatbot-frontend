            ...
            >
              {slides.map((s) => (
                <div key={s.src} className="relative w-full h-full flex-none">
                  <img alt={s.alt} src={s.src} className="w-full h-full object-cover select-none" draggable="false" />
            ...
            {features.map((f) => {
              ...
              return (
                <NavLink key={f.to} to={f.to} className="group block">
                  <div className={["relative overflow-hidden rounded-2xl p-6 bg-gradient-to-b", t.card, "ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:ring-1 hover:ring-black/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500"].join(" ")}>
                    ...
                    <div className="relative mb-4 flex items-center justify-between">
                      <div className={["relative w-14 h-14 bg-white rounded-2xl flex items-center justify-center shadow-sm ring-1 ring-black/5 transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-2 ring-offset-0"].join(" ")}>
